...
use crate::parsing_feedback::{get_parsing_feedback_manager, FeedbackStatistics, ParsingCorrection, ParsingFeedback};
use crate::recipe_import::{import_recipe_from_url, ImportedRecipe};
use crate::{conversions, database, logging};
use chrono::Utc;
...
#[tauri::command]
async fn download_recipe_image(app: tauri::AppHandle, image_url: String) -> Result<StoredImage, String> {
    let app_data_dir = get_app_local_data_dir(&app).map_err(|e| e.message)?;
...
pub(crate) fn parse_ingredient_string_fallback(ingredient_text: &str, section: Option<String>) -> Option<FrontendIngredient> {
...
pub(crate) fn parse_enhanced_amount(amount_str: &str) -> f64 {
...
pub(crate) fn is_measurement_unit(text: &str) -> bool {
...
pub(crate) fn clean_ingredient_name(name: &str) -> String {
...
fn convert_frontend_to_db_meal_plan(frontend: FrontendMealPlan) -> MealPlan {
    use crate::database::MealPlanSettings;
...
pub fn run_app() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::logging::get_log_directory_path,
            crate::logging::open_log_directory,
            get_parsing_metrics,
