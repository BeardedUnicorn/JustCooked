...
*   [ ] **2.1. Build the Dashboard Hub (`Dashboard.tsx`):**
    *   This is a new page.
...
*   [ ] **2.2. Build the Cookbook Hub (`Cookbook.tsx`):**
...
*   [ ] **2.3. Build the Planner Hub (`Planner.tsx`):**
...
*   [ ] **2.4. Build the Pantry Hub (`PantryHub.tsx`):**
...
*   [ ] **4.1. Delete Redundant Page Files:**
